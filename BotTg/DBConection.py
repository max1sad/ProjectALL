...
def execute_read_query(connection, query):
    ...
    try:
        ...
        logger.file_log(f"Метод - execute_read_query - {query} - '{e}'")

def add_query(connection,list_data,query):
    #print("добавление")
    ...
    try:
        ...
        logger.file_log(f"Метод - add_query - {e} - {query}  {list_data}")
    #cursor.close()
    #connection.close()
def delete_item(connection,query):
    with connection:
